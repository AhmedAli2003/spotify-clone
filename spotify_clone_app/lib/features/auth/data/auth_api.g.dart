...
class _AuthApi implements AuthApi {
  ...
  @override
  Future<TokensModel> refresh(RefreshTokenDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<void> logout(LogoutDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
...
String _$authApiHash() => r'a3471bcf483c23bbaef421f5589e1e92e58e7599';
